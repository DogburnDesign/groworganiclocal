...
define('SUBSCRIPTIO_VERSION', '2.1.1');
...
class Subscriptio
{
    ...
    public function manage_subscription_list_column_values($column, $post_id)
    {
        ...
        switch ($column) {
            ...
            case 'recurring_amount':
                echo self::get_formatted_price($subscription->renewal_order_total, $subscription->renewal_order_currency);
                break;
    ...
    public function enqueue_backend_assets_all()
    {
        ...
        wp_localize_script('subscriptio-backend-scripts-all', 'subscriptio_vars', array(
            ...
            'wc_version_23'              => (string) self::wc_version_gte('2.3'),
        ));
        ...
        // Datepicker styles
        wp_register_style('subscriptio-jquery-ui', SUBSCRIPTIO_PLUGIN_URL . '/assets/css/jquery-ui.css', array(), SUBSCRIPTIO_VERSION);
    ...
    {
        global $post;
        $product = Subscriptio::wc_version_gte('2.2') ? wc_get_product($post) : get_product($post);
