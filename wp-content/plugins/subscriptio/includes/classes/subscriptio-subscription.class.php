...
class Subscriptio_Subscription
{
    ...
    public function create_from_order_item($order, $order_meta, $order_item_id, $order_item, $product, $product_meta, $renewal)
    {
        ...
        $this->update_subscription_details(array(
            ...
            'renewal_all_items_meta'        => array($order_item['product_id'] => $order_item['item_meta']),
        ));
    ...
    public function create_from_all_order_items($order, $order_meta, $all_subs, $renewal)
    {
        ...
        foreach ($all_subs as $product_details) {
            ...
            $items_meta[$product_details['product_id']] = $product_details['order_item']['item_meta'];
        }
    ...
    public static function scheduled_date_check_and_change($new_date, $date_type, $subscription_id)
    {
        ...
        $scheduled_events = array(
            'renewal_order' => Subscriptio_Scheduler::get_scheduled_event_timestamp('subscriptio_scheduled_order', $subscription_id),
            'payment' => Subscriptio_Scheduler::get_scheduled_event_timestamp('subscriptio_scheduled_payment', $subscription_id),
            'reminder' => Subscriptio_Scheduler::get_scheduled_event_timestamp('subscriptio_scheduled_reminder', $subscription_id),
            'suspension' => Subscriptio_Scheduler::get_scheduled_event_timestamp('subscriptio_scheduled_suspension', $subscription_id),
            'cancellation' => Subscriptio_Scheduler::get_scheduled_event_timestamp('subscriptio_scheduled_cancellation', $subscription_id),
            'expiration' => Subscriptio_Scheduler::get_scheduled_event_timestamp('subscriptio_scheduled_expiration', $subscription_id),
        );
        ...
        if ($date_type == 'renewal_order') {
            ...
            Subscriptio_Scheduler::unschedule('subscriptio_scheduled_order', $subscription_id, $scheduled_events['renewal_order']);
            Subscriptio_Scheduler::schedule_order($subscription_id, $new_timestamp);
            $transaction->update_result('success');
        ...
        if ($date_type == 'payment') {
            ...
            // Re-schedule if checks were passed
            Subscriptio_Scheduler::unschedule('subscriptio_scheduled_payment', $subscription_id, $scheduled_events['payment']);
            Subscriptio_Scheduler::schedule_payment($subscription_id, $new_timestamp);
            $transaction->update_result('success');
        ...
        if ($date_type == 'reminder') {
            ...
            // Re-schedule if checks were passed
            Subscriptio_Scheduler::unschedule('subscriptio_scheduled_reminder', $subscription_id, $scheduled_events['reminder']);
            Subscriptio_Scheduler::schedule_reminder($subscription_id, $new_timestamp);
            $transaction->update_result('success');
        ...
        if ($date_type == 'suspension') {
            ...
            // Re-schedule if checks were passed
            Subscriptio_Scheduler::unschedule('subscriptio_scheduled_suspension', $subscription_id, $scheduled_events['suspension']);
            Subscriptio_Scheduler::schedule_suspension($subscription_id, $new_timestamp);
            $transaction->update_result('success');
        ...
        if ($date_type == 'cancellation') {
            ...
            // Re-schedule if checks were passed
            Subscriptio_Scheduler::unschedule('subscriptio_scheduled_cancellation', $subscription_id, $scheduled_events['cancellation']);
            Subscriptio_Scheduler::schedule_cancellation($subscription_id, $new_timestamp);
            $transaction->update_result('success');
        ...
        if ($date_type == 'expiration') {
            ...
            // Re-schedule if checks were passed
            Subscriptio_Scheduler::unschedule('subscriptio_scheduled_expiration', $subscription_id, $scheduled_events['expiration']);
            Subscriptio_Scheduler::schedule_expiration($subscription_id, $new_timestamp);
            $transaction->update_result('success');
    ...
    {
        // Either set timezone-adjusted time from the existing time or set it to just before midnight
        if ($current_timestamp) {
            $dt     = Subscriptio::get_datetime_object('@' . $current_timestamp);
            $hour   = $dt->format('H');
            $minute = $dt->format('i');
            $second = $dt->format('s');
        }
        ...
        $adjusted_date = Subscriptio::get_datetime_object($new_date);
        $adjusted_date->setTime($hour, $minute, $second);
        $adjusted_date = $adjusted_date->format('U');
     ...
     * @return array
     */
    public function show_variable_item_meta($meta)
    {
        if (is_array($meta)) {
