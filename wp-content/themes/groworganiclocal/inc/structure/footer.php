...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<br /> <?php printf( __( '%1$s by %2$s.', 'storefront' ), 'Website', '<a href="http://dogburndesign.com" alt="Dogburn Design" title="Dallas, TX Web Design" rel="designer">Dogburn Design</a>' ); ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
